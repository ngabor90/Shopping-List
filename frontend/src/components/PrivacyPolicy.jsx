...
export default function PrivacyPolicy({ onBack, dark, onToggleDark }) {
  return (
    <div className="policy-wrapper">
      ...
      <div className="policy-box">
        ...
        <div className="policy-section">
          ...
          <p>
            Your data is used solely to provide the Shopping List service. We do
            not sell, share, or use your data for marketing purposes.
          </p>
        </div>
        ...
        <div className="policy-section">
          ...
          <p>
            Your data is stored securely on our servers. Passwords are encrypted
            and never stored in plain text. We use browser local storage to keep
            you logged in between sessions.
          </p>
        </div>
